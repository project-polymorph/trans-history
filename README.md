...
我们提供了一个脚本来生成每年的跨性别新闻索引草稿。生成的草稿分为包含描述和不包含描述两种版本，分别存放在 `index_with_desc` 和 `index_without_desc` 目录中。每个文件以年份命名。

- [包含描述的索引草稿](index/index_with_desc)
- [不包含描述的索引草稿](index/index_without_desc)
